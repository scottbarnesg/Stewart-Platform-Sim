function theta = controller_v0(eangles, theta)
    ...
    d_theta = [A(1)*sin(eangles(3))+B(1)*sin(eangles(1))-C(1)*sin(eangles(2));
                A(2)*sin(eangles(3))+B(2)*-sin(eangles(1))-C(2)*sin(eangles(2));
                A(3)*sin(eangles(3))+B(2)*-sin(eangles(1))-C(3)*sin(eangles(2));
                A(4)*-sin(eangles(3))+B(2)*sin(eangles(1))-C(4)*sin(eangles(2));
                A(5)*-sin(eangles(3))+B(2)*-sin(eangles(1))-C(5)*sin(eangles(2));
                A(6)*sin(eangles(3))+B(2)*sin(eangles(1))-C(6)*sin(eangles(2))];
