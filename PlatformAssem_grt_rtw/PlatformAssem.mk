...
## Generated on : Mon Jan 29 16:19:53 2018
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/Users/Scott/Documents/GW/Senior Design/Simulation/V3
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
DEFINES_STANDARD = -DMODEL=PlatformAssem -DNUMST=2 -DNCSTATES=85 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
LIBS = D:/Program Files/MATLAB/R2017b/toolbox/physmod/sm/ssci/lib/win64/sm_ssci_lcc.lib D:/Program Files/MATLAB/R2017b/toolbox/physmod/sm/core/lib/win64/sm_lcc.lib D:/Program Files/MATLAB/R2017b/toolbox/physmod/pm_math/lib/win64/pm_math_lcc.lib D:/Program Files/MATLAB/R2017b/toolbox/physmod/simscape/engine/sli/lib/win64/ssc_sli_lcc.lib D:/Program Files/MATLAB/R2017b/toolbox/physmod/simscape/engine/core/lib/win64/ssc_core_lcc.lib D:/Program Files/MATLAB/R2017b/toolbox/physmod/network_engine/lib/win64/ne_lcc.lib D:/Program Files/MATLAB/R2017b/toolbox/physmod/common/math/core/lib/win64/mc_lcc.lib D:/Program Files/MATLAB/R2017b/toolbox/physmod/common/external/library/lib/win64/ex_lcc.lib D:/Program Files/MATLAB/R2017b/toolbox/physmod/common/foundation/core/lib/win64/pm_lcc.lib
...
D:/Program Files/MATLAB/R2017b/toolbox/physmod/sm/ssci/lib/win64/sm_ssci_lcc.lib : $(LIBSM_SSCI_LCC_OBJS)
	@echo "### Creating static library $@ ..."
	$(AR) $(ARFLAGS) /out:$@ $(LIBSM_SSCI_LCC_OBJS)


D:/Program Files/MATLAB/R2017b/toolbox/physmod/sm/core/lib/win64/sm_lcc.lib : $(LIBSM_LCC_OBJS)
	@echo "### Creating static library $@ ..."
	$(AR) $(ARFLAGS) /out:$@ $(LIBSM_LCC_OBJS)


D:/Program Files/MATLAB/R2017b/toolbox/physmod/pm_math/lib/win64/pm_math_lcc.lib : $(LIBPM_MATH_LCC_OBJS)
	@echo "### Creating static library $@ ..."
	$(AR) $(ARFLAGS) /out:$@ $(LIBPM_MATH_LCC_OBJS)


D:/Program Files/MATLAB/R2017b/toolbox/physmod/simscape/engine/sli/lib/win64/ssc_sli_lcc.lib : $(LIBSSC_SLI_LCC_OBJS)
	@echo "### Creating static library $@ ..."
	$(AR) $(ARFLAGS) /out:$@ $(LIBSSC_SLI_LCC_OBJS)


D:/Program Files/MATLAB/R2017b/toolbox/physmod/simscape/engine/core/lib/win64/ssc_core_lcc.lib : $(LIBSSC_CORE_LCC_OBJS)
	@echo "### Creating static library $@ ..."
	$(AR) $(ARFLAGS) /out:$@ $(LIBSSC_CORE_LCC_OBJS)


D:/Program Files/MATLAB/R2017b/toolbox/physmod/network_engine/lib/win64/ne_lcc.lib : $(LIBNE_LCC_OBJS)
	@echo "### Creating static library $@ ..."
	$(AR) $(ARFLAGS) /out:$@ $(LIBNE_LCC_OBJS)


D:/Program Files/MATLAB/R2017b/toolbox/physmod/common/math/core/lib/win64/mc_lcc.lib : $(LIBMC_LCC_OBJS)
	@echo "### Creating static library $@ ..."
	$(AR) $(ARFLAGS) /out:$@ $(LIBMC_LCC_OBJS)


D:/Program Files/MATLAB/R2017b/toolbox/physmod/common/external/library/lib/win64/ex_lcc.lib : $(LIBEX_LCC_OBJS)
	@echo "### Creating static library $@ ..."
	$(AR) $(ARFLAGS) /out:$@ $(LIBEX_LCC_OBJS)


D:/Program Files/MATLAB/R2017b/toolbox/physmod/common/foundation/core/lib/win64/pm_lcc.lib : $(LIBPM_LCC_OBJS)
	@echo "### Creating static library $@ ..."
