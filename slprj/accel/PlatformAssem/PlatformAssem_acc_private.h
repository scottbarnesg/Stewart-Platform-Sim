...
#ifndef RTW_HEADER_PlatformAssem_acc_private_h_
#define RTW_HEADER_PlatformAssem_acc_private_h_
#include "rtwtypes.h"
...
PlatformAssem_acc_rt_TDelayInterpolate ( real_T tMinusDelay , real_T tStart ,
